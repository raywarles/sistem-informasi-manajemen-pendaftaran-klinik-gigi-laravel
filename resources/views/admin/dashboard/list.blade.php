                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Antrian Hari ini</div>
                                    <div class="stat-digit"> {{$jml4}}</div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Antrian Hari ini : {{$mytime->format('d M Y')}}</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <?php $i = 0; ?>
                                            @foreach($antri as $ant)
                                            <tr>
                                                <td>
                                                    {{$i+=1}}
                                                </td>
                                                <td>{{$ant->nama}}</td>
                                                <td><span>{{$ant->no_antrian}}</span></td>
                                                <td>
                                                    <form action="{{route('antrians.set')}}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="id" value="{{$ant->id}}">
                                                            
                                                        <select class="form-control" name="status">
                                                            @if(Session::get('level') == 'Dokter')
                                                            <option {{ $ant->status == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                                            @else
                                                            <option {{ $ant->status == 'Menunggu' ? 'selected' : '' }}>Menunggu</option>
                                                            <option {{ $ant->status == 'Lewat' ? 'selected' : '' }}>Lewat</option>
                                                            <option {{ $ant->status == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                                            <option {{ $ant->status == 'Ditampilkan' ? 'selected' : '' }}>Ditampilkan</option>
                                                            @endif
                                                        </select>

                                                    
                                                </td>
                                                <td><button class="btn btn-success btn-sm" type="submit">Ubah</button></td>
                                                </form>
                                            </tr>
                                           @endforeach
                                        </tbody>
